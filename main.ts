...
export default class md2html extends Plugin {
	...
	async getRendered(): Promise<string> {
		...
		return this.clean('<div class="markdown-reading-view"' + html
